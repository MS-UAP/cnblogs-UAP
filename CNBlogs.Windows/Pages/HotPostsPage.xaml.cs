...
namespace CNBlogs.Pages
{
    ...
    /// </summary>
    public sealed partial class HotPostsPage : FlatNavigationPage
    {
        ...
        private void gv_HotPosts_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        {
            if (sz_HotPosts.IsZoomedInViewActive)
