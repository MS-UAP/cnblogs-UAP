...
namespace CNBlogs.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public bool ChangeNightMode()
        {
            if (CNBlogs.DataHelper.DataModel.CNBlogSettings.Instance.NightModeTheme)
            {
                CNBlogs.DataHelper.DataModel.CNBlogSettings.Instance.NightModeTheme = false;
                this.Page.RequestedTheme = ElementTheme.Light;
            }
            else
            {
                CNBlogs.DataHelper.DataModel.CNBlogSettings.Instance.NightModeTheme = true;
                this.Page.RequestedTheme = ElementTheme.Dark;
            }

            return CNBlogs.DataHelper.DataModel.CNBlogSettings.Instance.NightModeTheme;
        }
        #endregion
    }
