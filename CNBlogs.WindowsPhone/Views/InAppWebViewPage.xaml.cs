...
namespace CNBlogs
{
    ...
    /// </summary>
    public sealed partial class InAppWebViewPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public InAppWebViewPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null)
            {
                ...
                {
                    navUri = new Uri((string)e.Parameter);
                }
                else if (e.Parameter is Uri)
                {
                    navUri = e.Parameter as Uri;
                }

                if (navUri != null)
                {
                    this.wv_Content.Navigate(navUri);
                }
            }
        }
